<template>
  <div class="music-list">
    ...
    <div class="bg-image" :style="{backgroundImage: bgStyle, paddingTop: bgPaddingTop, zIndex: bgZIndex, transform: bgTransform, filter: bgFilter }" ref="bgImage" >
      <div class="filter" ref="filter"></div>
    </div>
    <div class="bg-layer" ref="layer" :style="{ transform: layerTransform }"></div>
    <scroll 
      @scroll="scroll"
